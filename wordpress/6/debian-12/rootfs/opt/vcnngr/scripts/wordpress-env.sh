...
# 2. Constants defined in this file (environment variables with no default), i.e. VCNNGR_ROOT_DIR
...
export VCNNGR_DEBUG="${VCNNGR_DEBUG:-false}"
...
# Paths
export WORDPRESS_BASE_DIR="${VCNNGR_ROOT_DIR}/wordpress"
export WORDPRESS_CONF_FILE="${WORDPRESS_BASE_DIR}/wp-config.php"
export WP_CLI_BASE_DIR="${VCNNGR_ROOT_DIR}/wp-cli"
...
export PATH="${VCNNGR_ROOT_DIR}/common/bin:${VCNNGR_ROOT_DIR}/mysql/bin:${PATH}"

# WordPress persistence configuration
export WORDPRESS_VOLUME_DIR="${VCNNGR_VOLUME_DIR}/wordpress"
...
export WORDPRESS_PASSWORD="${WORDPRESS_PASSWORD:-vcnngr}" # only used during the first initialization
...
export WORDPRESS_DATABASE_NAME="${WORDPRESS_DATABASE_NAME:-vcnngr_wordpress}" # only used during the first initialization
