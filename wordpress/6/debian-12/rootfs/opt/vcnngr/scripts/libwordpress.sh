...
. /opt/vcnngr/scripts/libfs.sh
. /opt/vcnngr/scripts/libos.sh
. /opt/vcnngr/scripts/libnet.sh
. /opt/vcnngr/scripts/libvalidations.sh
. /opt/vcnngr/scripts/libpersistence.sh
. /opt/vcnngr/scripts/libwebserver.sh
. /opt/vcnngr/scripts/libservice.sh

# Load database library
if [[ -f /opt/vcnngr/scripts/libmysqlclient.sh ]]; then
    . /opt/vcnngr/scripts/libmysqlclient.sh
elif [[ -f /opt/vcnngr/scripts/libmysql.sh ]]; then
    . /opt/vcnngr/scripts/libmysql.sh
elif [[ -f /opt/vcnngr/scripts/libmariadb.sh ]]; then
    . /opt/vcnngr/scripts/libmariadb.sh
fi
 ...
 * More info at: https://docs..com/general/apps/wordpress/troubleshooting/xmlrpc-and-pingback/
 */
if ( !defined( 'WP_CLI' ) ) {
...
wordpress_generate_web_server_configuration() {
    ...
    local template_dir="${VCNNGR_ROOT_DIR}/scripts/wordpress/vcnngr-templates"
